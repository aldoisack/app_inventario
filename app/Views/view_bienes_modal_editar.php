<form action="<?= base_url('bienes/actualizar') ?>" method="post" enctype="multipart/form-data">
    ...
    function previewImage(event) {
        ...
        if (file) {
            ...
            reader.onload = function(e) {
                ...
                const imgElement = document.getElementById("previewImg-modal-editar"); // Se refiere al id único de la imagen
